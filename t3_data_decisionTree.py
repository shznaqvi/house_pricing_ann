...
df = pd.read_csv('./data/t3_data.csv')

# print(df.shape)
# wait = input("[Shape] PRESS ENTER TO CONTINUE.")
#
# print(df.head())
# # print(sys.path)
# wait = input("[Head] PRESS ENTER TO CONTINUE.")
#
# dataset = df.values
# print(dataset)
# wait = input("[Dataset]PRESS ENTER TO CONTINUE.")

print(df.count())
wait = input("[Count]PRESS ENTER TO CONTINUE.")
